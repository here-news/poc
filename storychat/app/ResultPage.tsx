...
function ResultPage() {
  ...
  useEffect(() => {
    ...
    const fetchPreview = async () => {
      try {
        const response = await fetch(`/storychat/api/task/${taskId}/preview`, {
          headers: composeUserHeaders(userId)
        })
        const data = await response.json()
        setPreview(data)
  ...
  const handleClean = async () => {
    ...
    try {
      ...
      const response = await fetch(`/storychat/api/task/${taskId}/clean`, {
        method: 'POST',
        headers: composeUserHeaders(userId)
      })
  ...
  const handleSemantize = async () => {
    ...
    try {
      ...
      const response = await fetch(`/storychat/api/task/${taskId}/semantize`, {
        method: 'POST',
        headers: composeUserHeaders(userId)
      })
