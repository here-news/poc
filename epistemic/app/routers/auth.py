...
async def auth_callback(
    ...
    try:
        ...
        response = RedirectResponse(url=f"{settings.base_path}/")
        response.set_cookie(
            key="access_token",
            value=access_token,
            httponly=True,
